#!/usr/bin/env python3
"""
Dataset Generator for Neural Synchrony and Attentional Dynamics Study

This script generates a dataset demonstrating the temporal autocorrelation problem
in the context of neural synchrony and attention data, where testing relationships 
in time series data can lead to false positive findings when autocorrelation is 
not properly accounted for.

The script performs the following steps:
1. Runs materials/generate_data.py to create synthetic neural synchrony and attention data
...
def main():
    ...
    print("="*70)
    print("Neural Synchrony and Attentional Dynamics Dataset Generator")
    print("="*70)
    ...
    print("\n" + "-"*70)
    print("STEP 1: Generating synthetic neural synchrony and attention data")
    print("-"*70)
    ...
    try:
        ...
        # The README describes the (fake) neural synchrony study
    ...
    print("- Neural synchrony and attention time series with high autocorrelation")
    print("- Tests relationships that may appear significant due to temporal structure")
    print("- 1800 time points with 16 brain regions (120 region-pair synchrony values)")
