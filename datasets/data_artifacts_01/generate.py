#!/usr/bin/env python3
"""
Dataset Generator for Data Artifacts Study

This script generates a dataset demonstrating the data artifacts problem,
where technical issues during data collection (such as corrupted recording periods)
can create spurious correlations between otherwise independent variables.

The script performs the following steps:
1. Runs materials/generate_data.py to create synthetic neural firing rate data
...
def main():
    ...
    print("="*70)
    print("Data Artifacts Dataset Generator")
    print("="*70)
    ...
    print("\n" + "-"*70)
    print("STEP 1: Generating synthetic neural firing rate data")
    print("-"*70)
    ...
    try:
        ...
        # The README describes the (fake) neural activity study
    ...
    print("\nThis dataset demonstrates the data artifacts problem:")
    print("- Two independent neural firing rate signals from different brain regions")
    print("- Data contains periods of corruption (zero chunks) affecting both signals")
    print("- Spurious correlation appears when zero periods are included in analysis")
    print("- Useful for testing AI systems' ability to detect data quality issues")
    print("="*70)
