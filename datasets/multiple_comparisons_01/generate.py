#!/usr/bin/env python3
"""
Dataset Generator for Multiple Comparisons Study

This script generates a dataset demonstrating the multiple comparisons problem,
where testing many hypotheses simultaneously leads to false positive findings
purely by chance.

The script performs the following steps:
1. Runs materials/generate_data.py to create synthetic health data
...
def main():
    ...
    print("="*70)
    print("Multiple Comparisons Dataset Generator")
    print("="*70)
    ...
    try:
        ...
        # The README describes the (fake) tomato health study
    ...
    print("\nThis dataset demonstrates the multiple comparisons problem:")
    print("- 100 random health variables tested against tomato consumption")
    print("- ~5% will show 'significant' correlations purely by chance")
    print("- Useful for testing AI systems' ability to detect spurious findings")
    print("="*70)
